...
int main(int argc, char **argv)
{
    ...
    */
    ...
    transform.setOrigin( transform_origin.getOrigin() );		//	origin is equals to right shoulder origin
    transform.setRotation( );	// 	rotation is equals of openni_depth_frame
	...
	*/
	br.sendTransform(tf::StampedTransform(transform, ros::Time::now(), "openni_depth_frame", "arm_base_frame"));
